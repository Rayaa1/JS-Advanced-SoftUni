import { didUserDonation, donationPet, getTotalDonationCount} from '../data/bonusDonations.js'
import { deleteOffer, getById } from '../data/offers.js'
import { html } from '../lib.js'


const detailsTemplate = (pet, isOwner, onDelete, isLoggedIn, totalDonationCount, onClickDonation, didUserDonate) => html`<section id="detailsPage">
<div class="details">
    <div class="animalPic">
        <img src="${pet.image}">
    </div>
